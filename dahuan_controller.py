...
from umi.real_world.my_test_codes.dahuan_driver import DahuanBinaryDriver
...
class DHController(mp.Process):
    def __init__(self,
        ...
        super().__init__(name="DHGController")
    ...
    def start(self, wait=True):
        ...
        if wait:
            self.start_wait()
        if self.verbose:
            print(f"[DHGController] Controller process spawned at {self.pid}")
